  ...
  head: () => ({
    meta: [
      { title: "Who Winner World Cup? — Football NFT Battles on BSC" },
      {
        name: "description",
        content:
          "Collect legendary football NFTs, battle players, win $CUP. A Web3 football card battle game on Binance Smart Chain.",
      },
    ],
  }),
  component: Index,
          ...
          <div className="md:hidden glass-strong rounded-2xl mt-2 p-4 space-y-2 animate-fade-up">
            {links.map((l) => (
              <a
                ...
                className="block py-2 text-sm text-muted-foreground hover:text-neon-yellow"
              >
                {l.label}
              </a>
            ))}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
        <div className="animate-fade-up">
          ...
          <p className="mt-6 max-w-xl text-base sm:text-lg text-muted-foreground">
            Collect <span className="text-neon-yellow">legendary football NFTs</span>, battle other players in PvP
            arenas, and win <span className="text-neon-green">$CUP</span>. The first AAA Web3 football card battler on
            Binance Smart Chain.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#gameplay"
              className="group inline-flex items-center gap-2 rounded-xl bg-neon-yellow text-emerald-darker px-5 py-3 font-display tracking-wide glow-yellow hover:brightness-110 transition"
            >
            ...
            <a
              href="#cards"
              className="inline-flex items-center gap-2 rounded-xl bg-neon-green/15 border border-neon-green/40 text-neon-green px-5 py-3 font-display tracking-wide hover:bg-neon-green/25 transition"
            >
  ...
  return (
    <section id="gameplay" className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            FROM <span className="text-gradient-cup">MINT</span> TO <span className="text-gradient-cup">VICTORY</span>
          </>
        }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {steps.map((s, i) => (
          <div
            key={s.title}
            className="group relative glass rounded-2xl p-6 overflow-hidden hover:border-neon-yellow/40 transition"
          >
  ...
  return (
    <section id="cards" className="relative py-24 sm:py-32">
      ...
      <SectionHead
        ...
        title={
          <>
            OWN THE <span className="text-gradient-cup">GREATEST</span> CARDS
          </>
        }
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
        {players.map((p) => (
          <div key={p.name} className="group/card flex flex-col gap-3">
            ...
            <button
              onClick={() =>
                window.dispatchEvent(new CustomEvent("open-mint", { detail: { player: p, priceBNB: "0.05" } }))
              }
  ...
  return (
    <section className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            BUILT FOR <span className="text-gradient-cup">CHAMPIONS</span>
          </>
        }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 mt-14 grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {features.map((f) => (
          <div
            key={f.title}
            className="glass rounded-xl p-5 hover:-translate-y-1 hover:border-neon-green/40 transition"
          >
...
function Tokenomics() {
  ...
  const contract = "0x6094c6835399e7ea1ff43820f84ed44463d44444";
  return (
    <section id="token" className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            THE FUEL OF THE <span className="text-gradient-cup">ARENA</span>
          </>
        }
  ...
  return (
    <section className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            FIVE TIERS OF <span className="text-gradient-cup">GLORY</span>
          </>
        }
  ...
  return (
    <section className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            TRADE THE <span className="text-gradient-cup">FLOOR</span>
          </>
        }
        ...
        {listings.map((l) => (
          <div key={l.name} className="group glass rounded-2xl overflow-hidden hover:border-neon-yellow/40 transition">
            <div className="aspect-[4/5] overflow-hidden relative">
              ...
              />
              <div className="absolute top-3 left-3 clip-badge bg-neon-green/30 text-neon-green px-3 py-1 text-[10px] font-display tracking-widest">
                {l.trend}
              </div>
            </div>
  ...
  return (
    <section className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            SEASON 01 <span className="text-gradient-cup">LEADERBOARD</span>
          </>
        }
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 mt-14">
        <div className="glass-strong rounded-2xl overflow-hidden">
          <div className="grid grid-cols-[60px_1fr_90px_1fr_90px] sm:grid-cols-[80px_1fr_120px_1fr_120px] px-5 py-3 text-[10px] uppercase tracking-[0.25em] text-muted-foreground border-b border-neon-green/15">
            ...
            <div>Win %</div>
            <div>Prize</div>
            <div className="text-right">NFTs</div>
          </div>
          {leaders.map((p, i) => (
            <div
              key={p.name}
              className={`grid grid-cols-[60px_1fr_90px_1fr_90px] sm:grid-cols-[80px_1fr_120px_1fr_120px] px-5 py-4 items-center text-sm border-b border-neon-green/10 last:border-0 ${i === 0 ? "bg-neon-yellow/5" : ""}`}
            >
              <div className="font-display text-neon-yellow">#{p.rank}</div>
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-neon-yellow to-neon-green grid place-items-center text-emerald-darker font-display text-xs">
                  {p.name.slice(0, 2)}
                </div>
...
const roadmap = [
  {
    phase: "Phase 1",
    title: "Foundation",
    items: ["Website Launch", "Community Building", "$CUP Token Launch on BSC"],
    status: "live",
  },
  {
    phase: "Phase 2",
    title: "Genesis Mint",
    items: ["NFT Mint Launch", "PvP Battle Beta", "Marketplace Release"],
    status: "next",
  },
  {
    phase: "Phase 3",
    title: "Competitive",
    items: ["Ranked Tournament System", "Mobile Version", "Staking Platform"],
    status: "soon",
  },
  {
    phase: "Phase 4",
    title: "Global Stage",
    items: ["Global Championships", "Major Partnerships", "Esports Expansion"],
    status: "soon",
  },
];
  ...
  return (
    <section id="roadmap" className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            THE ROAD TO THE <span className="text-gradient-cup">FINAL</span>
          </>
        }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 mt-14 grid md:grid-cols-2 lg:grid-cols-4 gap-5">
        {roadmap.map((r, i) => {
          const accent =
            r.status === "live"
              ? "border-neon-yellow/50 glow-yellow"
              : r.status === "next"
          ...
          const tagColor =
            r.status === "live"
              ? "bg-neon-yellow text-emerald-darker"
              : r.status === "next"
              ...
              <ul className="mt-5 space-y-2.5">
                {r.items.map((it) => (
                  <li key={it} className="flex items-start gap-2 text-sm text-muted-foreground">
                    <Check
                      className={`h-4 w-4 mt-0.5 ${r.status === "live" ? "text-neon-yellow" : "text-neon-green/70"}`}
                    />
                    <span>{it}</span>
                  </li>
                ))}
...
const faqs = [
  {
    q: "What is Who Winner World Cup?",
    a: "A Web3 football NFT battle game built on Binance Smart Chain — collect player cards, build a team, and bet $CUP in PvP matches.",
  },
  {
    q: "How do I earn rewards?",
    a: "Win PvP matches and tournaments using your NFT football cards. Winners take the entire prize pool, paid on-chain.",
  },
  {
    q: "What is the minimum battle bet?",
    a: "Minimum 1,000 $CUP per match. Higher stakes unlock ranked arenas and premium tournaments.",
  },
  {
    q: "Can I trade my NFTs?",
    a: "Yes. Every card is a true BEP-20 NFT — buy, sell, upgrade and trade freely in the in-game marketplace.",
  },
  {
    q: "Is wallet connection required?",
    a: "Yes. You need MetaMask connected to BNB Smart Chain to play, mint and claim rewards.",
  },
  {
    q: "Which blockchain is used?",
    a: "Binance Smart Chain (BEP-20). The app auto-detects your network and offers to switch to BSC.",
  },
];
  ...
  return (
    <section id="faq" className="relative py-24 sm:py-32">
      <SectionHead
        ...
        title={
          <>
            NEED <span className="text-gradient-cup">ANSWERS</span>?
          </>
        }
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                <ChevronRight
                  className={`h-5 w-5 text-neon-yellow transition-transform ${active ? "rotate-90" : ""}`}
                />
              </div>
              <div
                className={`grid transition-all duration-300 ${active ? "grid-rows-[1fr] mt-3" : "grid-rows-[0fr]"}`}
              >
...
function Countdown() {
  ...
  const cell = (n: number, l: string) => (
    <div className="text-center">
      <div className="font-display text-4xl sm:text-5xl text-neon-yellow text-glow-yellow tabular-nums">
        ...
        <div className="relative glass-strong rounded-3xl p-10 sm:p-16 overflow-hidden text-center">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a
                href="#cards"
                className="inline-flex items-center gap-2 rounded-xl bg-neon-green/15 border border-neon-green/40 text-neon-green px-6 py-3 font-display hover:bg-neon-green/25 transition"
              >
                <Sparkles className="h-5 w-5" /> MINT NFT
              </a>
            </div>
...
function WalletButton() {
  ...
  return (
    <div className="relative">
      ...
      {openMenu && (
        <div
          className="absolute right-0 mt-2 w-72 glass-strong rounded-2xl p-4 z-50 animate-fade-up"
        ...
        >
          ...
          {!isBSC && (
            <button
              onClick={ensureBSC}
              className="mt-3 w-full rounded-lg bg-neon-yellow text-emerald-darker px-3 py-2 text-xs font-display tracking-wide"
            >
              SWITCH TO BSC
            </button>
          )}
          <button
            onClick={disconnect}
            className="mt-3 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-xs text-muted-foreground hover:text-foreground"
          >
...
function WalletModalRoot() {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] grid place-items-center p-4 bg-emerald-darker/80 backdrop-blur-md animate-fade-up"
      onClick={() => setOpen(false)}
    >
      <div className="w-full max-w-md glass-strong rounded-2xl p-6 relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-neon-yellow to-neon-green grid place-items-center text-emerald-darker font-display">
            M
          </div>
          <div>
        ...
        <div className="mt-5 rounded-xl bg-emerald-darker/70 border border-neon-green/15 p-4">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            We&apos;ll auto-switch your wallet to{" "}
            <span className="text-neon-green font-display ml-1">BNB Smart Chain</span>
          </div>
        </div>
        ...
        >
          <span className="flex items-center gap-3">
            <span className="h-10 w-10 rounded-lg bg-emerald-darker grid place-items-center font-display text-neon-yellow">
              M
            </span>
            <span className="text-left">
              <span className="block font-display tracking-wide text-foreground">MetaMask</span>
              <span className="block text-[11px] text-muted-foreground">
                {isInstalled ? "Detected · ready to connect" : "Not installed — opens metamask.io"}
              </span>
            </span>
          </span>
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 opacity-70">
          {[
            ...
            <button
              key={w.n}
              onClick={() => pushToast({ kind: "info", title: `${w.n} coming soon` })}
              className={`flex items-center gap-2 rounded-xl p-3 bg-gradient-to-r ${w.c} border border-white/10 text-xs`}
            >
              <span className="h-6 w-6 rounded bg-emerald-darker grid place-items-center font-display text-[10px] text-neon-green">
                {w.n[0]}
              </span>
    ...
    <div className="fixed top-[88px] inset-x-0 z-40 px-4">
      <div className="mx-auto max-w-2xl glass-strong rounded-xl px-4 py-2.5 flex items-center gap-3 border border-amber-400/40 animate-fade-up">
        ...
        <div className="text-xs text-foreground flex-1">
          Wrong network detected. Switch to <span className="text-neon-yellow font-display">BNB Smart Chain</span> to
          play.
        </div>
        <button
          onClick={ensureBSC}
          className="rounded-lg bg-neon-yellow text-emerald-darker px-3 py-1.5 text-[11px] font-display tracking-wide"
        >
          SWITCH
        </button>
      </div>
...
function ToastStack() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[110] space-y-2 w-[min(360px,calc(100vw-2rem))]">
      {items.map((t) => {
        const tone =
          t.kind === "ok" ? "border-neon-green/50" : t.kind === "err" ? "border-red-400/50" : "border-neon-yellow/50";
        ...
        return (
          <div
            key={t.id}
            className={`glass-strong rounded-xl p-3 flex items-start gap-3 border ${tone} animate-fade-up`}
          >
